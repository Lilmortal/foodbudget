...
docker pull 197204282783.dkr.ecr.ap-southeast-2.amazonaws.com/foodbudget-prod-api:latest
docker run -p 8080:8080 -d --restart on-failure 197204282783.dkr.ecr.ap-southeast-2.amazonaws.com/foodbudget-prod-api:latest
